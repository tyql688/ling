...
packages/host/src/
  ...
  domains/
    ...
    pi-adapters/           bundled Pi packages: todo, permission activation and voice input
...
| `features/pi-adapters/`, `features/companions/` | Todo projection, access mode, voice capture and settings, and the shared feature snapshot hook |
